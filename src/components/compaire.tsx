...
const chartData = [
  ...
  { month: "April", expenses: 733, income: 1940 },
  ...
  { month: "November", expenses: 4214, income: 140 },
...
export function ComparedChart() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Compared expenses and income money</CardTitle>
